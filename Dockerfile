...
RUN sed -e 's/;daemonize = yes/daemonize = no/' -i /etc/php5/fpm/php-fpm.conf \
    ...
    && echo "max_execution_time = 300" >> /etc/php5/fpm/php.ini \
    ...
    && echo "xdebug.profiler_output_dir='/var/www/xdebug'" >> /etc/php5/fpm/conf.d/20-xdebug.ini \
    && echo "xdebug.profiler_append=On" >> /etc/php5/fpm/conf.d/20-xdebug.ini \
    && echo "xdebug.profiler_enable_trigger=On" >> /etc/php5/fpm/conf.d/20-xdebug.ini 
